...
variable "gw_image_name" {
  default     = "cloudguard-edge-gateway"
  description = "The name of the Check Point Management Server that will be provisioned."
}

variable "CP_Version" {
  default     = "R80.20.15"
  description = "The version of Check Point to deploy. R80.20.15"
}
...
locals {
  gw_image_url    = "cos://${var.VPC_Region}/checkpoint-${var.VPC_Region}/Check_Point_${var.CP_Version}_Cloudguard_Edge.qcow2"
}
